...
Metrics Tracking for Scrum Master — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on metrics tracking within the context of Scrum Master. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## Metrics Tracking

### Core Framework

This reference provides detailed guidance on metrics tracking as applied within Scrum Master.

### Scrum Metrics and Tracking

#### Sprint Metrics

| Metric | Formula | Target | Warning Sign |
|--------|---------|--------|-------------|
| Velocity | Story points completed per sprint | Stable trend | >20% variance |
| Sprint burndown | Remaining work over time | Linear descent | Flat or rising |
| Commitment reliability | Completed / Committed × 100 | >80% | <70% |
| Escaped defects | Bugs found after sprint | Decreasing | Increasing |
| Sprint goal success | Goals met / Goals set × 100 | >90% | <70% |

#### Team Health Metrics

- **Happiness index**: Regular team satisfaction surveys
- **Improvement rate**: Retrospective actions completed
- **Knowledge sharing**: Cross-training and pairing frequency
- **Impediment resolution time**: Average time to resolve

#### Using Metrics Responsibly

- Use metrics for team improvement, never for individual performance
- Compare team against itself over time, not against other teams
- Focus on trends, not individual data points
- Let the team own and discuss their metrics
