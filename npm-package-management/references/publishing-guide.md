...
Publishing Guide for NPM Package Management — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on publishing guide within the context of NPM Package Management. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## npm Publishing Guide

### Package Publishing Workflow

1. **Prepare package.json**: Ensure name, version, main/module/exports fields
2. **Build**: Compile TypeScript, bundle if needed
3. **Test**: Run full test suite
4. **Version**: `npm version patch/minor/major`
5. **Publish**: `npm publish` (or `npm publish --access public` for scoped)
...
- Prefer `files` field in package.json for explicit inclusion
- Always exclude: tests, source, configs, documentation (except README)
