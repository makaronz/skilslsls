# DSP Audience Strategies

DSP Audience Strategies for Amazon DSP Programmatic — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on dsp audience strategies within the context of Amazon DSP Programmatic. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## Amazon Platform Overview

Understanding Amazon's advertising ecosystem is essential for effective dsp audience strategies. The platform offers unique capabilities that differentiate it from other advertising channels.

### Platform Strengths

- **Audience reach**: Access to Amazon's user base with granular targeting options
