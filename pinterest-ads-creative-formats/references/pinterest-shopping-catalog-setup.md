# Pinterest Shopping Catalog Setup

Pinterest Shopping Catalog Setup for Pinterest Ads Creative Formats — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on pinterest shopping catalog setup within the context of Pinterest Ads Creative Formats. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## Pinterest Platform Overview

Understanding Pinterest's advertising ecosystem is essential for effective pinterest shopping catalog setup. The platform offers unique capabilities that differentiate it from other advertising channels.
...
Before setting up Pinterest advertising API access:

1. **Business account**: Create and verify a Pinterest business account
...
```
1. Register application in Pinterest developer portal
