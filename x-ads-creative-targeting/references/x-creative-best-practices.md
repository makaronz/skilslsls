# X Creative Best Practices

X Creative Best Practices for X Ads Creative Targeting — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on x creative best practices within the context of X Ads Creative Targeting. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## X (Twitter) Platform Overview

Understanding X (Twitter)'s advertising ecosystem is essential for effective x creative best practices. The platform offers unique capabilities that differentiate it from other advertising channels.

### Platform Strengths

- **Audience reach**: Access to X (Twitter)'s user base with granular targeting options
...
|--------|-----------|-----------|----------|----------|
| Single Image | 1080x1080, 1200x628 | JPG, PNG | 30MB | N/A |
| Video | 1080x1080, 1080x1920, 1920x1080 | MP4, MOV | 4GB | 5s–60s |
| Carousel | 1080x1080 per card | JPG, PNG | 30MB/card | N/A |
| Stories/Vertical | 1080x1920 (9:16) | JPG, PNG, MP4 | Varies | 5–15s |

### Creative Best Practices

#### Visual Design

- **Mobile-first**: Design for small screens — use large text, clear imagery
- **Brand consistency**: Maintain brand colors, fonts, and tone across creatives
- **Text overlay**: Keep text minimal — under 20% of image area
- **Contrast**: Ensure CTAs stand out against backgrounds
- **Authenticity**: Use real imagery over stock photos when possible

#### Video Creative

- **Hook in 3 seconds**: Capture attention immediately
- **Sound-off design**: Use captions and visual storytelling
- **Vertical format**: Prioritize 9:16 for mobile feeds and stories
- **Clear CTA**: End with a strong call-to-action
- **Branding early**: Show brand within first 3 seconds

#### Copy Guidelines

- **Headlines**: 5–8 words, benefit-driven
- **Primary text**: Front-load the value proposition
- **CTA buttons**: Match CTA to campaign objective
- **A/B testing**: Test headlines, descriptions, and CTAs independently

### Creative Refresh Strategy

| Signal | Action | Timeline |
|--------|--------|----------|
| CTR drops >20% | Refresh creatives | Within 1 week |
| Frequency >3.0 | Rotate new variants | Immediately |
| CPM increases >30% | Test new formats | Within 2 weeks |
| Engagement plateaus | Test new messaging angles | Monthly |
