...
Corporate Contracts for Contract Review Analysis — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on corporate contracts within the context of Contract Review Analysis. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.
...
|------|-----------|------------|
| SaaS agreements | SLA, data handling, termination | Auto-renewal, price escalation |
| Service agreements | Scope, deliverables, timeline | Scope creep, liability caps |
| NDAs | Definition, duration, exceptions | Overbroad definitions |
| Employment | Compensation, IP, non-compete | Enforceability, jurisdiction |
| Vendor/Supplier | Payment terms, quality, warranties | Force majeure, indemnification |
