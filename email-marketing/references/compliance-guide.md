...
Compliance Guide for Email Marketing — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on compliance guide within the context of Email Marketing. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.
...
|-----------|--------|------------------|
| CAN-SPAM | USA | Physical address, unsubscribe link, honest subject lines |
...
| PECR | UK | Consent for marketing, clear opt-out |

### Consent Management

- **Double opt-in**: Confirm subscription via email (required in some regions)
- **Preference center**: Let subscribers choose email types and frequency
- **Unsubscribe**: Process within 10 business days (CAN-SPAM), immediately (best practice)
- **Record keeping**: Log consent timestamp, source, and scope

### Privacy by Design

- Minimize data collection to what's necessary
- Implement data retention policies
- Provide clear privacy policy links in emails
