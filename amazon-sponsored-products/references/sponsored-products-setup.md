...
Sponsored Products Setup for Amazon Sponsored Products — comprehensive strategies, implementation details, and best practices.

---

## Introduction

This reference provides detailed, actionable guidance on sponsored products setup within the context of Amazon Sponsored Products. Use this document as a deep-dive resource when implementing the strategies outlined in the main SKILL.md file.

## Amazon Platform Overview

Understanding Amazon's advertising ecosystem is essential for effective sponsored products setup. The platform offers unique capabilities that differentiate it from other advertising channels.
...
Before setting up Amazon advertising API access:

1. **Business account**: Create and verify a Amazon business account
...
```
1. Register application in Amazon developer portal
